...
class Test_Lesson(unittest.TestCase):
    ...
    def test_str(self):
        ...
        self.assertEqual(str(lesson1), "Programowanie1 (MON 8:30-10:00)\nPierwszy rok studiów stacjonarnych\nProwadzący: Polak")
        self.assertEqual(str(lesson2), "Matematyka (FRI 17:30-19:30)\nDrugi rok studiów niestacjonarnych\nProwadzący: Kowal")
        self.assertEqual(str(lesson3), "Polski (THU 17:30-18:01)\nTrzeci rok studiów stacjonarnych\nProwadzący: Nill")
        self.assertEqual(str(lesson4), "Fizyka (SAT 8:05-8:09)\nCzwarty rok studiów niestacjonarnych\nProwadzący: Nowak")
