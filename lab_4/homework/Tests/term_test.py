import unittest
from lab_4.homework.deanerySystem.Term_class import Term
from lab_4.homework.deanerySystem.Day_class import Day

class Test_Term(unittest.TestCase):

    def test_Term_Class(self):
        self.assertEqual(str(Term(Day.MON, 10, 45)), "Poniedziałek 10:45 [90]")
        self.assertEqual(str(Term(Day.TUE, 11, 15)), "Wtorek 11:15 [90]")
        self.assertEqual(str(Term(Day.WED, 12, 10)), "Środa 12:10 [90]")
        self.assertEqual(str(Term(Day.THU, 15, 0)), "Czwartek 15:00 [90]")
        self.assertEqual(str(Term(Day.FRI, 5, 23)), "Piątek 5:23 [90]")
        self.assertEqual(str(Term(Day.SAT, 14, 18)), "Sobota 14:18 [90]")
        self.assertEqual(str(Term(Day.SUN, 12, 3)), "Niedziela 12:03 [90]")
